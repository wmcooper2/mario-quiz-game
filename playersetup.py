...
##        player.score_position = score_display.index(score_sprite)   #this is to reduce the need for O(n^2) loops when updating scores, and links the player to their score
