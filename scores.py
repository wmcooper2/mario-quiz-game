...
class ScoreSprite(c.SPRITE):
    def __init__(self, player, *args, **kwargs):
        super().__init__(player.left, *args, **kwargs)
        self.points = 0
        self.x = 0
